          ...
          <div className="about-row about-gx-0">
            ...
            <div className="about-col-lg-6 about-d-flex about-align-items-center" data-aos="zoom-out" data-aos-delay="200">
              <div style={{
                ...
                <img src={logo} alt="DevSquad Logo" style={{width: 120}}/>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="about-row about-justify-content-center">
            <div className="about-col-lg-6 about-col-md-8" data-aos="zoom-in" data-aos-delay="200">
              <div className="about-team-member">
                <div className="about-team-img">VS</div>
                {/* <img src={Founder} alt="" className='about-team-img' /> */}
                <h4>Vipin Suthar</h4>
                <div className="about-position">Founder & Lead Developer</div>
                <p>
                ...
                <div className="about-social-links">
                  <a href="https://www.instagram.com/__vipinn.09/" target='_blank'><i className="bi bi-instagram"></i></a>
                  <a href="https://github.com/Vipin8200" target='_blank'><i className="bi bi-github"></i></a>
                  <a href="https://www.linkedin.com/in/vipin-suthar-929a77298/" target='_blank'><i className="bi bi-linkedin"></i></a>
                  <a href="https://www.linkedin.com/company/devsquad-it-solutions/" target='_blank'><i className="bi bi-building"></i></a>
                </div>
              </div>
            </div>
          </div>
