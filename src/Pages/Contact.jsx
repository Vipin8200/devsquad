          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="contact-card-hover bg-white rounded-2xl p-8 text-center border border-gray-100" data-aos="zoom-in" data-aos-delay="100">
              ...
              <p className="text-sm text-gray-500">
                ...
                <a href="tel:+919123456789" className="hover:text-purple-600 transition-colors">
                  +91 81603 85225
                </a>
              </p>
            </div>
            ...
            <div className="contact-card-hover bg-white rounded-2xl p-8 text-center border border-gray-100" data-aos="zoom-in" data-aos-delay="200">
              ...
              <p className="text-sm text-gray-500">
                <a href="mailto:devsquad.agency@gmail.com" className="hover:text-purple-600 transition-colors">
                  devsquad.agency@gmail.com
                </a><br />
              </p>
            </div>
            ...
            <div className="space-y-8" data-aos="fade-right">
              <div>
                <h3 className="text-2xl font-bold text-gray-900 mb-4">
                  Why Choose <span className="gradient-text">DevSquad</span>?
                </h3>
